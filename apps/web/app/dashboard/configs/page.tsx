  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">AI Configurations</h1>
          <p className="text-slate-500 mt-1">Manage your industry-specific AI qualification agents.</p>
        </div>
        <Link 
